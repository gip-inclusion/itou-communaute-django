...
- Ajustement des espacements entre le titre, la descption et le bouton "voir les sous-commnautés" (#155)
- security fix (#154)
- Maj du theme itou vers la v0.5.8 (#153)
...
## v1.4 - 2023.01.30
- Mise à jour des dépendances pour la nouvelle release (#149)
- Désactivation du bouton “Répondre” dans le fil des topics quand le formulaire est ouvert (#148)
- Optimisation des requêtes de la vue d'un Forum (aka fil d'actualités d'une communauté) (#147)
...
## v1.2 - 2023.01.16
- FIX PR139 - Stats - ordonner les périodes pour les graphes (#140)
- [fix urgent] Stats - ordonner les périodes pour les graphes (#139)
...
- Maj du theme itou vers la v0.5.7 (#134)

## v1.1 - 2023.01.09
- Mise à jour des dépendances - release 09.01.2023 (#133)
